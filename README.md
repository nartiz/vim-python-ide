...
### Bash 
```
sh -c "$(curl -fsSL https://raw.githubusercontent.com/nartiz/vim-python-ide/master/setup.sh)"
```
### Fish
```
curl -fsSL https://raw.githubusercontent.com/nartiz/vim-python-ide/master/setup.sh | sh       
```
### YouCompleteMe
